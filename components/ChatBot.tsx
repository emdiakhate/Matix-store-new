...
export default function ChatBot() {
  ...
  const handleShareWhatsApp = async () => {
    console.log('🚀 Tentative de partage WhatsApp avec photos...');
    ...
    const announcementData = {
      ...
      photos: uploadedPhotos // ✅ Inclure les photos uploadées
    };
    
    console.log('📦 Données de l\'annonce:', announcementData);
    console.log(`📸 Nombre de photos: ${uploadedPhotos.length}`);
    
    // Tenter d'ouvrir WhatsApp avec photos
    const success = await shareToWhatsApp(announcementData, true); // true = avec photos
    
    if (success === true) {
      // Succès : WhatsApp s'est ouvert
      showToast(
        '📱 Partage en cours... Sélectionnez WhatsApp dans le menu de partage',
        'success'
      );
      ...
      showToast(
        '⚠️ Veuillez autoriser les popups pour partager',
        'error'
      );
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 animate-fadeIn">
          <div className="bg-white rounded-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto shadow-2xl animate-scaleIn">
            ...
            <div className="p-6">
              ...
              {/* ========================================= */}
              {/* Section de partage multi-plateformes    */}
              {/* ========================================= */}
              <div className="mt-6 pt-6 border-t-2 border-gray-200">
                ...
                <div className="grid grid-cols-4 gap-3">
                  ...
                  <button
                    ...
                    className="flex flex-col items-center gap-2 p-4 bg-white border-2 border-gray-200 rounded-xl hover:border-[#25D366] hover:bg-green-50 transition-all group"
                    title="WhatsApp"
                  >
                    ...
                    <span className="text-xs font-medium text-gray-700 group-hover:text-[#25D366]">WhatsApp</span>
                  </button>
                  ...
                  <button
                    onClick={() => {
                      ...
                      const success = shareToFacebook(announcementData);
                      if (success) showToast('Facebook ouvert !', 'success');
                    }}
                    className="flex flex-col items-center gap-2 p-4 bg-white border-2 border-gray-200 rounded-xl hover:border-[#1877F2] hover:bg-blue-50 transition-all group"
                    title="Facebook"
                  >
                    ...
                    <span className="text-xs font-medium text-gray-700 group-hover:text-[#1877F2]">Facebook</span>
                  </button>
                  ...
                  <button
                    onClick={() => {
                      ...
                      const success = shareToTwitter(announcementData);
                      if (success) showToast('Twitter ouvert !', 'success');
                    }}
                    className="flex flex-col items-center gap-2 p-4 bg-white border-2 border-gray-200 rounded-xl hover:border-black hover:bg-gray-50 transition-all group"
                    title="Twitter/X"
                  >
                    ...
                    <span className="text-xs font-medium text-gray-700 group-hover:text-black">Twitter</span>
                  </button>
                  ...
                  <button
                    onClick={() => {
                      ...
                      const success = shareByEmail(announcementData);
                      if (success) showToast('Email ouvert !', 'success');
                    }}
                    className="flex flex-col items-center gap-2 p-4 bg-white border-2 border-gray-200 rounded-xl hover:border-red-500 hover:bg-red-50 transition-all group"
                    title="Email"
                  >
                    <div className="w-12 h-12 bg-red-500 rounded-full flex items-center justify-center text-white group-hover:scale-110 transition-transform">
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/>
                        <polyline points="22,6 12,13 2,6"/>
                      </svg>
                    </div>
                    <span className="text-xs font-medium text-gray-700 group-hover:text-red-500">Email</span>
                  </button>
                  ...
                  <button
                    onClick={() => {
                      ...
                      const success = shareBySMS(announcementData);
                      if (success) showToast('SMS ouvert !', 'success');
                    }}
                    className="flex flex-col items-center gap-2 p-4 bg-white border-2 border-gray-200 rounded-xl hover:border-green-600 hover:bg-green-50 transition-all group"
                    title="SMS"
                  >
                    <div className="w-12 h-12 bg-green-600 rounded-full flex items-center justify-center text-white group-hover:scale-110 transition-transform">
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
                      </svg>
                    </div>
                    <span className="text-xs font-medium text-gray-700 group-hover:text-green-600">SMS</span>
                  </button>
                  ...
                  <button
                    onClick={async () => {
                      ...
                      const success = await copyAnnouncementLink(announcementData);
                      if (success) showToast('✓ Lien copié !', 'success');
                    }}
                    className="flex flex-col items-center gap-2 p-4 bg-white border-2 border-gray-200 rounded-xl hover:border-purple-500 hover:bg-purple-50 transition-all group"
                    title="Copier le lien"
                  >
                    <div className="w-12 h-12 bg-purple-500 rounded-full flex items-center justify-center text-white group-hover:scale-110 transition-transform">
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/>
                        <path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/>
                      </svg>
                    </div>
                    <span className="text-xs font-medium text-gray-700 group-hover:text-purple-500">Copier</span>
                  </button>
                  ...
                  <button
                    onClick={() => {
                      ...
                      const message = `🐔 *${announcementData.productType}* 🐔

💰 Prix : *${announcementData.price} FCFA*/${announcementData.unit}
📦 Disponible : ${announcementData.quantity} ${announcementData.unit}
📍 Localisation : ${announcementData.location}

👉 *Voir toutes les photos et détails :*
${window.location.origin}/annonces/${announcementData.id}

───────────────────
✨ Trouvé sur *Matix* - Marketplace avicole 🇸🇳`;
                      const telegramUrl = `https://t.me/share/url?url=${encodeURIComponent(window.location.origin + '/annonces/' + announcementData.id)}&text=${encodeURIComponent(message)}`;
                      window.open(telegramUrl, '_blank');
                      showToast('Telegram ouvert !', 'success');
                    }}
                    className="flex flex-col items-center gap-2 p-4 bg-white border-2 border-gray-200 rounded-xl hover:border-[#0088cc] hover:bg-blue-50 transition-all group"
                    title="Telegram"
                  >
                    ...
                    <span className="text-xs font-medium text-gray-700 group-hover:text-[#0088cc]">Telegram</span>
                  </button>
                  ...
                  {typeof navigator !== 'undefined' && 'share' in navigator && (
                    <button
                      onClick={async () => {
                        ...
                        const success = await shareNative(announcementData);
                        if (!success) showToast('Annulé', 'info');
                      }}
                      className="flex flex-col items-center gap-2 p-4 bg-white border-2 border-gray-200 rounded-xl hover:border-gray-400 hover:bg-gray-50 transition-all group"
                      title="Plus d'options"
                    >
                      <div className="w-12 h-12 bg-gray-400 rounded-full flex items-center justify-center text-white group-hover:scale-110 transition-transform">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                      ...
                      <span className="text-xs font-medium text-gray-700 group-hover:text-gray-900">Plus</span>
                    </button>
                  )}
                </div>

                <p className="text-xs text-gray-500 text-center mt-3">
                  💡 Sur mobile, les photos seront incluses dans le partage WhatsApp
                </p>
              </div>
              {/* ========================================= */}
              {/* FIN : Section de partage multi-plateformes */}
              {/* ========================================= */}
