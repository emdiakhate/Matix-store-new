...
export default function OpportuniteRow({
  opportunite,
  onShowDetails,
  onUpdateOffer,
}: OpportuniteRowProps) {
      ...
      <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
        ...
        <td className="py-3 px-2">
          <div className="truncate">
            <div
              ...
              title={opportunite.titreAnnonce}
            >
              {opportunite.titreAnnonce}
            </div>
            <div className="text-xs text-gray-500 truncate">#{opportunite.referenceAnnonce}</div>
            <div className="text-xs text-gray-400">{opportunite.datePublication}</div>
          </div>
        </td>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="min-w-0 flex-1">
              <div
                ...
                title={opportunite.distributeur.nom}
              >
                {opportunite.distributeur.nom}
              </div>
              <div className="text-xs text-gray-500 truncate">{opportunite.distributeur.ville}</div>
              <div className="text-xs text-yellow-600">⭐ {opportunite.distributeur.note}</div>
            </div>
          </div>
        </td>
        ...
        <td className="py-3 px-2">
          <div>
            <div
              className="font-medium text-gray-900 text-sm truncate"
              title={opportunite.produitDemande}
            >
            ...
            <div className="text-xs text-gray-500 truncate">{opportunite.categorie}</div>
          </div>
        </td>
        ...
        <td className="py-3 px-2">
          <div>
            ...
            <div className="text-xs text-gray-500">{opportunite.monOffre.dateOffre}</div>
          </div>
        </td>
        ...
        <td className="py-3 px-2">
          ...
          >
            {opportunite.monOffre.prix <= opportunite.budgetMax ? '✓ OK' : '✗ Hors budget'}
          </div>
        </td>
        ...
        <td className="py-3 px-2">
          ...
          {opportunite.statut === 'Acceptée' && opportunite.dateAcceptation && (
            <div className="text-xs text-green-600 mt-1">{opportunite.dateAcceptation}</div>
          )}
        </td>
        ...
        <td className="py-3 px-2">
          ...
          >
            {opportunite.joursRestants > 0 ? `${opportunite.joursRestants}j` : 'Expirée'}
          </div>
        </td>
